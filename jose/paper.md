...
- Create the necessary raw data for \textbf{GemGIS} and \textbf{GemPy} using the open-source software QGIS
- Explore and manipulate the raw data using the Pandas \citep{pandas} and GeoPandas libraries \citep{geopandas}
- Process the raw data using \textbf{GemGIS} to create input data for \textbf{GemPy}
- Create the 3D structural model using \textbf{GemPy}
- Visaulize the results using Matplotlib \citep{matplotlib} and PyVista \citep{pyvista}
